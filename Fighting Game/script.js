...
class Player {
    ...
    strike(player, enemy, attackDmg) {
        ...
        return message = `${player.name} attacks ${enemy.name} for ${damageAmount}`
    }
    ...
    heal(player) {
        ...
        return message = `${player.name} heals for ${hpAmount} HP`
    }
}
...
class Game {
    ...
    play(p1, p2) {
        ...
        return game.declareWinner(game.isOver, p1, p2)
    }
...
let Player2 = new Player(player2Name, 100, 9)
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'q' && Player2.health > 0 && game.isOver == false) {
        p1.strike(Player1, Player2, Player1.attackDmg)
        let p1strike = document.getElementById('p1Strike')
        p1Strike.play()
    }
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'p' && Player1.health > 0 && game.isOver == false) {
        p2.strike(Player2, Player1, Player2.attackDmg)
        let p2strike = document.getElementById('p2Strike')
        p2Strike.play()
    }
